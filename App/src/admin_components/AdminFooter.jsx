export default function AdminFooter() {
  return (
    <>
      <footer className='mt-3 pt-10 pb-1 bg-[#683f56] relative text-white font-bold'>
        <img
          src='https://d32vkgmd6unjtd.cloudfront.net/static/images/backgrounds/hills_chocPeanutButter.png'
          alt=''
          className='absolute -top-40 left-0 w-full h-40 bg-repeat-x bg-bottom bg-contain'
        />
        <div className='max-w-[75rem] mx-auto flex'>
          <div className='w-1/4 px-4'>
            <div className='flex flex-col w-full m-0 p-0 justify-center'>
              <p className='m-0 text-xl font-bold'>NEWSLETTER</p>
              <input
                type='email'
                className='w-full h-auto py-2 mt-5 px-5 border-none rounded-md bg-[#f2f2f2] text-black text-base'
          ...
          <div className='w-1/4 px-4'>
            <div className='flex flex-col w-full m-0 p-0 justify-center'>
              <p className='m-0 text-xl font-bold'>USEFUL LINKS</p>
          ...
          <div className='w-1/4 px-4'>
            <div className='flex flex-col w-full m-0 p-0 justify-center'>
              <p className='m-0 text-xl font-bold'>CONTACT DETAILS</p>
              <ul className='mb-8 list-none mt-5 p-0 m-0'>
                <li className='mb-3'>
          ...
          <div className='w-1/4 px-4'>
            <div className='flex flex-col w-full m-0 p-0 justify-center'>
              <p className='m-0 text-xl font-bold'>CONNECT WITH US</p>
